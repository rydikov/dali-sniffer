...
extern const char web_styles_css_start[] asm("_binary_styles_css_start");
extern const char web_styles_css_end[] asm("_binary_styles_css_end");
...
{
    return send_embedded_file(req, "text/html; charset=utf-8", web_index_html_start, web_index_html_end);
}

static esp_err_t styles_get_handler(httpd_req_t *req)
{
    return send_embedded_file(req, "text/css; charset=utf-8", web_styles_css_start, web_styles_css_end);
}

static esp_err_t script_get_handler(httpd_req_t *req)
{
    return send_embedded_file(req, "text/javascript; charset=utf-8", web_app_js_start, web_app_js_end);
}
...
esp_err_t web_server_start(void)
{
    ...
    ESP_ERROR_CHECK(httpd_register_uri_handler(s_server, &styles_uri));
